...
{
    [Activity(Label = "RestaurantPage1")]
    public class RestaurantPage1 : Activity
    {
        TextView uname1;
        TextView rname1;
        Button favBtn1;
        ...
        protected override void OnCreate(Bundle savedInstanceState)
        {
            ...
            SetContentView(Resource.Layout.Edulis);
            uname1 = FindViewById<TextView>(Resource.Id.ur);
            rname1 = FindViewById<TextView>(Resource.Id.info5);
                ...
                myBtn1.Click += delegate
            {
                ...
                alert1.SetMessage("10% Off on all food items for kids");
